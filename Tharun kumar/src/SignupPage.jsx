import './App.css';
import { Button, ButtonGroup, Card, CardActions, CardHeader, FormHelperText, FormLabel, Grid, Input, InputAdornment, InputLabel, label } from '@material-ui/core';
        ...
        <Grid item xs={4} >
          <h1>photoshooto</h1>
            <ButtonGroup className={classes.btnGrp}>
              <Button className={classes.btn} id="login"
                onClick={LoginHandler}
              >Login</Button>
              <Button className={classes.btn} id="signup"
