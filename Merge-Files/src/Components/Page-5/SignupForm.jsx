      ...
      <form>
        ...
        >
          <div>
            ...
            <br />
            <input type="text" placeholder="First Name" style={StylesTwo} />
          </div>

          <div>
            <label>Last Name</label>
            <br />
            <input type="text" placeholder="Last Name" style={StylesTwo} />
          </div>
        </div>
        ...
        >
          ...
          <br />
          <input type="text" placeholder="username" style={StylesOne} />
          <br />

          <label>Email</label>
          <br />
          <input type="email" placeholder="Email" style={StylesOne} />
          <br />

          <label>Password</label>
          <br />
          <input type="Password" placeholder="Email" style={StylesOne} />
          <br />
          <br />
          ...
          <div style={{}}>
            <IconButton style={{ float: "left", color: "blue" }}>
              <CallIcon />
            </IconButton>
            <IconButton
              style={{
